...
<div class="container">
    ...
    <button type="button" class="btn btn-success d-flex flex-row"><span class="material-symbols-outlined">
        description
        </span>Write new journal</button>


    <div class="d-flex flex-column w-100 mt-4 chat-place gap-2">
        <div class="container w-100 bg-primary rounded-3 p-3">
            <h3 class="mb-0">Today's Work</h3>
            <p class="mb-0">Written on 28/2/2023</p>
        </div>
        <div class="container w-100 bg-primary rounded-3 p-3">
            <h3 class="mb-0">Today's Work</h3>
            <p class="mb-0">Written on 28/2/2023</p>
